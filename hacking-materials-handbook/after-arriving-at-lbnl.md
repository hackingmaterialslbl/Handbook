...
* **Familiarize yourself with the division web site for administrative requests.** There are now standard procedures how to navigate various administrative items (e.g., requesting a key to your office, requesting conference travel, etc.) at the [ETS Admin & Operations](https://sites.google.com/lbl.gov/etsintranet) web site. You will need to be logged in to your LBL Google Account (and perhaps on LBNL network or VPN) to access it.
* **Set up your office.** &#x20;
