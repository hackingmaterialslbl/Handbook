...
* **As soon as possible** - submit a conference travel request form. This form is a very basic (i.e., 2 minutes to fill out) - find the appropriate approval forms on the [ETS Admin & Operations](https://sites.google.com/lbl.gov/etsintranet) web site. Here are some important things to note:
  ...
  * Note that our group’s travel arranger is Brandi Thompson and Kings Ogbeni.
...
* If you haven’t done so already, make sure your travel profile (e.g., your frequent flier programs) are completed for the lab. E-mail etsadmin@lbl.gov if you don’t have one yet.
